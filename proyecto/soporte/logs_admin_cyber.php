...
<head>
    ...
    <style>
        ...
        .logs-table tbody tr:hover { background: #11203a; box-shadow: 0 3px 18px #00ffae33; border-left: 5px solid #00ffae; }
        ...
        .fa-clipboard-list { color: #00ffae; }
...
<div class="container py-4">
    <div class="logs-table-container mx-auto">
        <div class="logs-header d-flex flex-wrap flex-md-nowrap justify-content-between align-items-center mb-3 shadow">
            <h2 class="mb-0"><i class="fas fa-clipboard-list me-2"></i>LOGS DE SEGURIDAD</h2>
        </div>
        <!-- Filtros de búsqueda -->
        <form class="row g-2 mb-4 filter-form align-items-end log-filters-bg px-3 py-3" method="get" autocomplete="off">
            ...
            <div class="col-md-1 d-grid">
                <?php if ($busqueda || $event_type || $user_id): ?>
                    <a href="logs_admin_cyber.php" class="btn btn-outline-danger" title="Limpiar filtros"><i class="fas fa-times"></i></a>
                <?php endif; ?>
            </div>
        </form>
