...
// Si 'eliminar-reposo.php' está en 'tu_proyecto/reposo/',
// y 'conexion.php' está en 'tu_proyecto/', entonces '../conexion.php' es correcto.
// Si ambos están en la misma carpeta 'reposo', la ruta debería ser 'conexion.php'.
...
try {
    ...
    // Si la carpeta 'uploads' está en la raíz de tu proyecto (ej. htdocs/proyecto/uploads/reposos/),
    // y este archivo (eliminar-reposo.php) está en una subcarpeta (ej. htdocs/proyecto/reposo/),
    // entonces la ruta para unlink() podría necesitar ser '../uploads/reposos/nombre_archivo.ext'.
    // Asegúrate de que la ruta aquí sea la correcta para tu estructura de directorios.
