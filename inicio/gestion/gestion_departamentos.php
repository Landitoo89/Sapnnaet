...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['eliminar_departamento'])) {
        ...
        // Obtener datos del departamento para el log
        ...
        // Verificar si el departamento tiene coordinaciones asociadas
    ...
    if (isset($_POST['action']) && $_POST['action'] === 'add') {
        ...
        if (!empty($nombre)) {
            ...
            if ($stmt->execute()) {
                ...
                registrarLog($conexion, $current_user_id, 'departamento_added', "Nuevo departamento: $nombre");
            } else {
    ...
    if (isset($_POST['action']) && $_POST['action'] === 'edit') {
        ...
        if (!empty($nombre)) {
            ...
            if ($stmt->execute()) {
                ...
                registrarLog($conexion, $current_user_id, 'departamento_edited', "Departamento editado: $nombre (ID: $id)");
            } else {
...
$sql_total = "SELECT COUNT(*) AS total FROM departamentos $condicion";
...
$sql = "SELECT * FROM departamentos $condicion ORDER BY id_departamento DESC LIMIT ? OFFSET ?";
